...
import youRello from '../image/YouRello-logos_black.png';
    ...
    <header>
      <div className='flex flex-col md:flex-row items-center p-5  bg-gray-500/10 rounded-b-2xl'>
        ...
        <Image
          ...
          width={200}
          height={150}
          className='w-44 h-20 md:w-56 pb-10 md:pb-0 object-cover scale-150'
        ></Image>
        ...
        <div className='flex items-center space-x-5 flex-1 justify-end w-full'>
          ...
          <Avatar name='You Jun' round size='50' color='#0055D1' />
        </div>
      </div>
